...
#TODO: clean up code, add readme and comments to make easily understandable
...
with PyChromeBrowser(0, {"settings": {"scripts": ["1-FindLoginLinks"], "headless":False}, # Set headless to false for optimal performance
...
# config = {"oauth_button" : ['facebook', {'attributes': ['class', 'gr-button gr-button--facebook gr-button--dark gr-button--auth facebookConnectButton fbSignInButton', 'style', 'margin-bottom: 14px', 'href', 'https://www.facebook.com/v3.1/dialog/oauth?client_id=2415071772&redirect_uri=https%3A%2F%2Fwww.goodreads.com%2Fuser%2Fnew&scope=email%2Cuser_friends&state=fb_oauth_state_36668164-ae00-4705-8fc6-6d5c853e30b7']}]}
